...
function showPopup(topic) {
    ...
    switch (topic) {
        case 'atletas':
            imageSrc = 'atletass.jpg'; // Caminho da imagem dos atletas
            textContent = content.atletas; // Texto sobre atletas
            break;
        case 'olimpiadas':
            imageSrc = 'olimpiadass.jpg'; // Caminho da imagem das olimpíadas
            textContent = content.olimpiadas; // Texto sobre olimpíadas
            break;
        case 'esportes':
            imageSrc = 'esportee.jpg'; // Caminho da imagem dos esportes
            textContent = content.esportes; // Texto sobre esportes
            break;
        case 'estadios':
            imageSrc = 'estadioos.jpg'; // Caminho da imagem dos estádios
            textContent = content.estadios; // Texto sobre estádios
            break;
        case 'eventos':
            imageSrc = 'eventoo.jpg'; // Caminho da imagem dos eventos
            textContent = content.eventos; // Texto sobre eventos
            break;
        case 'torcida':
            imageSrc = 'torcidaa.jpg'; // Caminho da imagem da torcida
